...
export default function CircleList({ height }: { height: number }) {
  ...
  // SVG and circle-specific logic
  const cx = height;
  const cy = height / 2;
  const rOuter = height / 3;
  const thickness = rOuter / 2.5;

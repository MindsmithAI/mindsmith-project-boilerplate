...
interface TableCellProps {
  ...
  handleToggleColumnHeader: () => void
}

const TableCell: React.FC<TableCellProps> = ({ content, editMode, className, width, updateCell, handleToggleHeader, handleToggleColumnHeader, handleDeleteColumn, handleDeleteRow, handleAddColumn, handleAddRow, handleSetWidth, handleMoveColumn, handleMoveRow, rowIndex, index }) => {
    ...
    {editMode && (
      <DropdownMenu open={isMenuOpen} onOpenChange={() => setIsMenuOpen(false)}>
        ...
        <DropdownMenuContent>
          ...
          <DropdownMenuSeparator />
          <DropdownMenuItem onClick={handleToggleHeader}>Toggle Header</DropdownMenuItem>
          <DropdownMenuItem onClick={handleToggleColumnHeader}>Toggle Column Header</DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
    )}
    </td>
